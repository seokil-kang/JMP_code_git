function epsilon = structural_shock_kalman(theta,Y,ME_scale)
...
if boundcheck == 0
    ...
    if (eu(1) == 1) && (eu(2) == 1)
        ...
        for t = 1:T
            ...
            % put the epsilon_t into the basket
            epsilon = [epsilon epsilon_t];
